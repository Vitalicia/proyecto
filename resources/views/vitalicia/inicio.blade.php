	...
	<div id="insideV-about-us" data-section="nosotros">
		<div class="container">
			<div class="row row-bottom-padded-lg" id="about-us">
                ...
                <div class="col-md-6 to-animate text-justify">
                    <h2>Visi&oacute;n</h2>
                    <p>Ser una empresa con la mayor cantidad de clientes satisfechos a nivel estatal vasados en la mejora continua en nuestros servicios; manteniendo el bienestar familiar y los valores &eacute;ticos y profesionales de nuestro personal</p>
				</div>
                <div class="col-md-12 col-md-offset-3 to-animate">
                <div class="col-md-6 to-animate">
				    <h2>Objetivos</h2>
                    <p class="text-justify">Contruir una empresa l&iacute;der en atenci&oacute;n Gerontol&oacute;gica que promueva la calidad de vida del usuario e independencia funcional, satisfaciendo sus necesidades de manera integral y participativa</p>
                    <ul>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
					...
					<div class="row">
						<div class="col-md-8 col-md-offset-2 single-animate animate-features-2">
							<h3>Rehabilitaci&oacute;n Fis&iacute;ca orientado a personas que sufren de lesiones y enfermedades.</h3>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row row-bottom-padded-sm">
                ...
                <li>
                    ...
                    <a href="mailto:info@vitalicia.com.mx"><strong>Escr&iacute;benos</strong></a>
                       ...
                       <div class="row">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d559.9006105930946!2d-99.53802299100887!3d19.258550200584228!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85cdf4ce3b645a21%3A0xec973c1ccea94a7a!2sJos%C3%A9+Vicente+Villada+Pte.+614%2C+San+Francisco%2C+San+Mateo+Atenco%2C+M%C3%A9x.!5e0!3m2!1ses-419!2smx!4v1551675329172" width="600" height="450" frameborder="0" style="border:0" allowfullscreen></iframe>          
                        </div>
                        <div class="row">
